...
@Getter
public class BukkitTrustEvent extends BukkitPlayerEvent implements TrustEvent, Cancellable {
    ...
    protected BukkitTrustEvent(@NotNull OnlineUser user, @NotNull Claim claim, @NotNull ClaimWorld claimWorld,
