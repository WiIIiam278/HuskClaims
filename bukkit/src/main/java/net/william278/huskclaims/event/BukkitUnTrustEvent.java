...
@Getter
public class BukkitUnTrustEvent extends BukkitPlayerEvent implements UnTrustEvent, Cancellable {

    private final Claim claim;
    private final ClaimWorld claimWorld;
    private final TrustLevel formerTrustLevel;
    private final Trustable unTrusted;
    @Setter
    ...
    protected BukkitUnTrustEvent(@NotNull OnlineUser user, @NotNull Claim claim, @NotNull ClaimWorld claimWorld,
        ...
        this.formerTrustLevel = trustLevel;
        this.unTrusted = trusted;
    }
}
