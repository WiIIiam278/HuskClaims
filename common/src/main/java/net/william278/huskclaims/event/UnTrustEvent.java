...
public interface UnTrustEvent extends OnlineUserEvent, ClaimEvent, CancellableEvent {

    @NotNull
    Trustable getUnTrusted();

    @NotNull
    TrustLevel getFormerTrustLevel();
    ...
    default boolean isChildClaim() {
        return getParentClaim().isPresent();
    }
