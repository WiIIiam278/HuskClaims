...
public interface FabricDeleteClaimEvent extends FabricEventCallback<DeleteClaimEvent> {
    ...
    @NotNull
    Event<FabricDeleteClaimEvent> EVENT = EventFactory.createArrayBacked(FabricDeleteClaimEvent.class,
            (listeners) -> (event) -> {
                for (FabricDeleteClaimEvent listener : listeners) {
    ...
    final class Callback implements DeleteClaimEvent {
        ...
        @NotNull
        public Event<FabricDeleteClaimEvent> getEvent() {
            return EVENT;
        }
